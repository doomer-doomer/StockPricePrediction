...
export default function Home() {
 ...
 // const counter = useSelector((state)=>state.counter);
  ...
  const getIndices = async()=>{
      ...
      await fetch("http://localhost:5000/longhistory/^NSEI/max/1d",{method:"GET"})
      .then(response => {
        if (response.ok) {
      ...
      await fetch("http://localhost:5000/longhistory/^NSEBANK/max/1d",{method:"GET"})
      .then(response => {
        if (response.ok) {
          return response.json();
        } else {
      ...
      await fetch("http://localhost:5000/longhistory/^BSESN/max/1d",{method:"GET"})
      .then(response => {
        if (response.ok) {
          return response.json();
        } else {
  ...
  const getIndicesData = async()=>{
     ...
     await fetch("http://localhost:5000/info/^NSEI",{method:"GET"})
      .then(response => {
        if (response.ok) {
          return response.json();
        } else {
     ...
     await fetch("http://localhost:5000/info/^NSEBANK",{method:"GET"})
      .then(response => {
        if (response.ok) {
          return response.json();
        } else {
     ...
     await fetch("http://localhost:5000/info/^BSESN",{method:"GET"})
      .then(response => {
        if (response.ok) {
          return response.json();
        } else {
  ...
  const getMoreIndicesData = async()=>{
    await fetch("http://localhost:5000/nifty50",{method:"GET"})
     .then(response => {
       if (response.ok) {
         return response.json();
       } else {
 ...
 const bankSector = async()=>{
  await fetch("http://localhost:5000/bankSector",{method:"GET"})
  .then(response => {
    if (response.ok) {
      return response.json();
    } else {
